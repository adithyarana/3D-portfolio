       ...
       mx-auto'>
        ...
        >
          ...
          <p className='text-white text-[18px] font-bold
           cursor-pointer'>Adithya <span className='text-red-400'>Rana</span></p>
        </Link>
...
{/* // side nav bar  */}
       ...
       <div className='sm:hidden flex flex-1 justify-end items-center'>
        ...
        <div className={`${!toggle ? 'hidden' : 'flex'} p-6 black-gradient
         absolute top-20 mx-4 my-2  min-w-[140px] z-10 rounded-xl`}>

          <ul className='list-none flex  
       justify-end flex-col flex-start gap-4'>
        {navLinks.map((link)=>(
