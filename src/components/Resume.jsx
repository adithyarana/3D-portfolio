  ...
  return (
   ...
   <p className= {styles.sectionSubText } >
      ...
      <div>
        ...
        >
            <a href="https://drive.google.com/file/d/1UBPNfa_EP_fwLu-9uq9EHbk3CK5E7BpA/view?usp=sharing" target='_blank'  rel="noopener noreferrer" className='m-2 text-lg'>  <FontAwesomeIcon className='mr-2'  icon={faDownload} color="#ffffff" size="1x" />Resume</a>
